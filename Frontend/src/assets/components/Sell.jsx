...
const SellCoupon = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // कस्टम टोस्ट पॉपअप मध्यभागी दाखवणे
    const toastId = toast(
      ({ closeToast }) => {
        ...
        return (
          <div className="flex flex-col items-center p-4 bg-white rounded-lg shadow-lg">
            <p className="text-sm sm:text-base text-gray-800 mb-4 text-center">
              Please confirm your details are correct. Submitting wrong information may lead to account blocking.
            </p>
            <div className="flex items-center gap-2 mb-4">
              ...
              />
              <label className="text-sm text-gray-700">I confirm the details are correct</label>
            </div>
            <button
